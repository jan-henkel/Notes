...
Type part of the name of an entry you wish to select into the text field on a level with the "Entry" label.
...
To select an entry, click on it in the list, or navigate the list with the arrow keys if necessary.
...
If you wish to include a clickable URL in your note, there are 2 ways of going about it:
...
Some URLs (e.g. those not beginning with "www.") might require "http://" or "https://" to work.
